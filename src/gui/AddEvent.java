...
public class AddEvent extends JDialog {
	 ...
	 * @param modal
	 */
	public AddEvent(WindowFrame parent, String title, boolean modal, PicView pcw){
	...
	public void initStyle(){
		this.bdNom = BorderFactory.createTitledBorder("Nom de l'évènement");
		this.bdPers = BorderFactory.createTitledBorder("Personne(s) de l'évènement");
	...
	public void initActions(){
		this.plus.addActionListener(new ActionListener(){
	    	public void actionPerformed(ActionEvent arg0) {        
	    		try {
					Personne p = new Personne(AddEvent.this.persNom.getText(),AddEvent.this.persMail.getText());
					AddEvent.this.listPersonnes.put(p.getMail(), p);
					AddEvent.this.persArea.setText(AddEvent.this.listPersonnes.toString());
		...
		this.moins.addActionListener(new ActionListener(){
	    	public void actionPerformed(ActionEvent arg0) {        
	    		AddEvent.this.listPersonnes.remove(AddEvent.this.persMail.getText());
	    		AddEvent.this.persArea.setText(AddEvent.this.listPersonnes.toString());
	    	}      
	    });
		...
		this.okBouton.addActionListener(new ActionListener(){
	    	public void actionPerformed(ActionEvent arg0) {
	    		if(AddEvent.this.nom.getText().length()!=0) {
	    			AddEvent.this.pcw.ajouterEvent(new Event(AddEvent.this.nom.getText(),AddEvent.this.listPersonnes));
	    		}
	    		else
